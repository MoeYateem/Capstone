<template>
  ...
  <li>
    <div>
      <span class="font-semibold">Card Number:</span> {{ cards.value.card_number }}
    </div>
    <div>
      <span class="font-semibold">Expiry Date:</span> {{ cards.value.expiry_date }}
    </div>
    <div>
      <span class="font-semibold">SRN:</span> {{ cards.value.srn }}
    </div>
